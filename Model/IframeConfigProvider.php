...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $transType = $this->scopeConfiguration->getValue(
            'payment/bluepay_iframe_payment/payment_action',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        ) == "authorize" ? "AUTH" : "SALE";
        $hashstr = $this->scopeConfiguration->getValue(
            'payment/bluepay_iframe_payment/secret_key',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            ) .
            $this->scopeConfiguration->getValue(
                'payment/bluepay_iframe_payment/account_id',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            ) .
            //$transType .
            $this->scopeConfiguration->getValue(
                'payment/bluepay_iframe_payment/trans_mode',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );
            ...
            'payment' => [
                'bluepay_iframe_payment' => [
                    ...
                    'cctypes' => $this->scopeConfiguration->getValue(
                        'payment/bluepay_iframe_payment/cctypes',
                        \Magento\Store\Model\ScopeInterface::SCOPE_STORE
                    ),
                    'availableTypes' => $this->getCcAvailableTypes('bluepay_iframe_payment'),
                    'months' => $this->getCcMonths(),
                    'years' => $this->getCcYears(),
                    'hasVerification' => $this->hasVerification('bluepay_iframe_payment'),
                    'hasSsCardType' => $this->hasSsCardType('bluepay_iframe_payment'),
                    'ssStartYears' => $this->getSsStartYears(),
                    'cvvImageUrl' => $this->getCvvImageUrl(),
                    'active' => $this->scopeConfiguration->getValue(
                        'payment/bluepay_iframe_payment/active',
                        \Magento\Store\Model\ScopeInterface::SCOPE_STORE
                    ),
                    'paymentTypes' => $this->scopeConfiguration->getValue(
                        'payment/bluepay_iframe_payment/payment_type',
                        \Magento\Store\Model\ScopeInterface::SCOPE_STORE
                    ),
                    'allowAccountsStorage' => $this->scopeConfiguration->getValue(
                        'payment/bluepay_iframe_payment/tokenization',
                        \Magento\Store\Model\ScopeInterface::SCOPE_STORE
                    ),
                    ...
                    'useCvv2' => $this->scopeConfiguration->getValue(
                        'payment/bluepay_iframe_payment/useccv',
                        \Magento\Store\Model\ScopeInterface::SCOPE_STORE
                    ),
                    'level3' => $level3,
                ...
                'ccform' => [
                    'icons' => $this->getIcons(),
                    'availableTypes' => ['bluepay_iframe_payment' => $this->getCcAvailableTypes('bluepay_iframe_payment')]
                ]
            ]
    ];
        return $config;
